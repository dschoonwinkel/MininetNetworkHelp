...
def sendeth(ethernet_packet, payload, interface = "en3"):
  """Send raw Ethernet packet on interface."""
  s = socket(AF_UNIX, SOCK_RAW)

  # From the docs: "For raw packet
  # sockets the address is a tuple (ifname, proto [,pkttype [,hatype]])"
  s.bind((interface, 9190))
...
if __name__ == "__main__":
      ...
      ipv4_header = [0x45, 0x00, 0x00, 0x54, 0x90, 0x15, 0x40, 0x00, 0x40, 0x01,
                     0xd4, 0x73, 0x0a, 0x0b, 0x01, 0x08, 0x0a, 0x0b, 0x01, 0x03]

      # echo (ping) request, checksum 2b45, etc
      icmp_ping = [0x08, 0x00, 0x0f, 0x5d, 0x77, 0x60, 0x00, 0x06, 0x58, 0x8b, 0x17,
                   0x3b, 0x00, 0x0d, 0x16, 0x66, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d,
