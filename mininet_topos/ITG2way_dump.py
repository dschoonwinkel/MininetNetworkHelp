...
def main():
    ...
    h1.cmd("xterm -fg black -bg cyan -geometry 80x12+950+0 -e \"bash ITGSend.bash 10.0.0.1 10.0.0.2; bash\" &")
    h2.cmd("xterm -fg black -bg yellow -geometry 80x12+950+550 -e \"bash ITGSend.bash 10.0.0.2 10.0.0.1; bash\" &")
