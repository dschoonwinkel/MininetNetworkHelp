...
ITGSend -T UDP -a $addr2 -rp 10002 -C 1 -c 1200 -t 2000 -x ./logs/receiver_$addr2.log -l ./logs/sender_$addr1.log -Sda $addr2 -Sdp 11234 -p 2 -Fp ./data_files/random1M.txt
